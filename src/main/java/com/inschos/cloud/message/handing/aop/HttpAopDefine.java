package com.inschos.cloud.message.handing.aop;
...
import com.inschos.cloud.message.handing.access.rpc.client.AccountClient;
import com.inschos.cloud.message.handing.annotation.GetActionBeanAnnotation;
import com.inschos.cloud.message.handing.assist.kit.*;
...
public class HttpAopDefine {
    ...
    @Around("@annotation(com.inschos.cloud.message.handing.annotation.GetActionBeanAnnotation)")
